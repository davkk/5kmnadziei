...
import { useSiteMetadataQuery } from '@queries';

const Head = ({ pageTitle, imageUrl, customSiteDescription }) => {
  const {
    siteTitle,
    siteTitleShort,
    siteDescription,
      ...
      {({ location }) => {
        ...
        return (
          <Helmet>
            ...
            <meta
              content={customSiteDescription || siteDescription}
              name="description"
            />
            <meta
              content={customSiteDescription || siteDescription}
...
Head.propTypes = {
  ...
  customSiteDescription: PropTypes.string,
};
